...
return [
    'acl' => [
        ...
        'commercial-executions' => 'Execuções',
        'commercial-deliveries' => 'Auditoria de Envios',
        'dispatch' => 'Disparar',
        'warehouses' => 'Armazéns',
        'inventory' => 'Estoque',
    ],
    ...
    'contacts' => [
        ...
        'account-products' => [
            'save-success' => 'Relacionamento comercial salvo com sucesso.',
            'delete-success' => 'Relacionamento comercial removido com sucesso.',
        ],
    ],
    'products' => [
        'index' => [
        ...
        'index' => [
            ...
            'general' => [
                ...
                'settings' => [
                    ...
                    'footer' => [
                        'info' => 'Você pode configurar aqui a seção "Desenvolvido por".',
                        'powered-by' => 'Editor do texto "Desenvolvido por"',
                    ...
                    'menu' => [
                        ...
                        'draft' => 'Rascunho',
                        'inbox' => 'Caixa de Entrada',
                        'info' => 'Você pode configurar aqui os nomes dos itens de menu.',
                        'leads' => 'Oportunidades',
                        'mail' => 'E-mail',
                        'organizations' => 'Empresas',
                        'outbox' => 'Caixa de Saída',
                    ...
                    'menu-color' => [
                        ...
                        'info' => 'Você pode alterar aqui as cores dos itens de menu.',
            ...
            'email' => [
                ...
                'smtp' => [
                    ...
                    'info' => 'Configure o envio SMTP para e-mails transacionais e campanhas.',

                    'account' => [
                        'title' => 'Conta SMTP',
                        'title-info' => 'Configure aqui os dados do seu servidor SMTP.',
                        'host' => 'Host',
                        'port' => 'Porta',
                    ...
                    'test' => [
                        'test-btn' => 'Testar configuração',
                        'modal-title' => 'Teste de configuração SMTP',
                        'modal-info' => 'Envie um e-mail real de teste usando os valores SMTP preenchidos neste formulário.',
                        'recipient' => 'E-mail destinatário de teste',
                        'recipient-placeholder' => 'nome@exemplo.com',
                        'send-btn' => 'Enviar e-mail de teste',
                        'testing-btn' => 'Enviando...',
                        'subject' => '[ :app_name ] E-mail de teste SMTP',
                        'body' => 'Este é um e-mail de teste SMTP enviado em :datetime por :app_name.',
                        'success' => 'E-mail de teste SMTP enviado com sucesso para :email.',
                        'validation-error' => 'Informe um e-mail destinatário válido e os campos SMTP obrigatórios.',

                        'errors' => [
                            'generic' => 'Não foi possível enviar o e-mail de teste SMTP.',
                            'authentication' => 'Falha de autenticação SMTP. Verifique usuário e senha.',
                            'host' => 'Não foi possível resolver o host SMTP. Verifique o nome do host.',
                            'port' => 'Não foi possível conectar ao servidor SMTP. Verifique host e porta.',
                            'timeout' => 'Tempo de conexão SMTP esgotado. Verifique timeout, rede e firewall.',
                            'tls' => 'Falha na negociação TLS/SSL. Verifique criptografia e certificado.',
                            'from-address' => 'Endereço do remetente rejeitado. Verifique o campo "E-mail do remetente".',
                        ],
                    ],
                ],
            ...
            'whatsapp' => [
                ...
                'info' => 'Configure provedores de WhatsApp e parâmetros de conexão.',

                'provider' => [
                    'driver' => 'Provedor ativo',
                ...
                'waha' => [
                    'base-url' => 'URL Base WAHA',
                    'api-key' => 'API Key WAHA',
                    'session' => 'Sessão WAHA',
                    'timeout' => 'Timeout WAHA (segundos)',
                ],

                'evolution' => [
                    'base-url' => 'URL Base Evolution',
                    'api-key' => 'API Key Evolution',
                    'instance' => 'Instância Evolution',
                    'timeout' => 'Timeout Evolution (segundos)',
                ],

                'test' => [
                    'test-btn' => 'Testar configuração',
                    'validation-error' => 'Preencha os campos obrigatórios do provedor selecionado.',

                    'success' => [
                        'meta' => 'Conexão Meta Oficial validada com sucesso.',
                        'waha' => 'Conexão WAHA validada com sucesso.',
                        'evolution' => 'Conexão Evolution validada com sucesso.',
                    ],

                    'errors' => [
                        'generic' => 'Não foi possível validar a configuração do WhatsApp.',
                        'invalid-driver' => 'Provedor de WhatsApp selecionado é inválido.',
                        'host' => 'Host inacessível. Verifique URL, rede e firewall.',
                        'meta-token' => 'Access token Meta inválido.',
                        'meta-business-id' => 'Business Account ID Meta inválido.',
                        'meta-phone-id' => 'Phone Number ID Meta inválido.',
                        'waha-api-key' => 'API key WAHA inválida.',
                        'waha-session' => 'Sessão WAHA não encontrada.',
                        'evolution-api-key' => 'API key Evolution inválida.',
                        'evolution-instance' => 'Instância Evolution não encontrada.',
                    ],
                ],

                'test-message' => [
                    'test-btn' => 'Enviar mensagem de teste',
                    'modal-title' => 'Enviar mensagem de teste no WhatsApp',
                    'modal-info' => 'Envia uma mensagem real usando o provedor e as configurações atuais.',
                    'phone' => 'Telefone',
                    'phone-placeholder' => 'ex: +5511999999999',
                    'message' => 'Mensagem',
                    'message-placeholder' => 'Digite uma mensagem curta de teste...',
                    'send-btn' => 'Enviar mensagem',
                    'sending-btn' => 'Enviando...',
                    'validation-error' => 'Informe telefone e mensagem.',

                    'success' => [
                        'meta' => 'Mensagem de teste Meta enviada com sucesso para :phone.',
                        'waha' => 'Mensagem de teste WAHA enviada com sucesso para :phone.',
                        'evolution' => 'Mensagem de teste Evolution enviada com sucesso para :phone.',
                    ],

                    'errors' => [
                        'generic' => 'Não foi possível enviar a mensagem de teste de WhatsApp.',
                        'invalid-driver' => 'Provedor de WhatsApp selecionado é inválido.',
                        'invalid-phone' => 'Telefone inválido. Use formato internacional com código do país.',
                        'host' => 'Host inacessível. Verifique URL, rede e firewall.',
                        'meta-token' => 'Access token Meta inválido.',
                        'waha-api-key' => 'API key WAHA inválida.',
                        'waha-session' => 'Sessão WAHA não encontrada.',
                        'waha-session-disconnected' => 'Sessão WAHA desconectada ou indisponível.',
                        'evolution-api-key' => 'API key Evolution inválida.',
                        'evolution-instance' => 'Instância Evolution não encontrada.',
                        'evolution-instance-disconnected' => 'Instância Evolution desconectada ou indisponível.',
                    ],
                ],
            ],
    ...
    'layouts' => [
        ...
        'events' => 'Eventos',
        'events-info' => 'Adicionar, editar ou excluir eventos do CRM',
        'campaigns' => 'Campanhas',
        'campaigns-info' => 'Adicionar, editar ou excluir campanhas do CRM',
        'workflows' => 'Fluxos de Trabalho',
        'workflows-info' => 'Adicionar, editar ou excluir fluxos de trabalho do CRM',
        'webhooks' => 'Webhooks',
        'webhooks-info' => 'Adicionar, editar ou excluir webhooks do CRM',
        'other-settings' => 'Outras Configurações',
        ...
        'data_transfer_info' => 'Gerencie as configurações de transferência de dados de pessoas, produtos e oportunidades no CRM',
        'commercial' => 'Comercial',
        'commercial-campaigns' => 'Campanhas',
        'commercial-executions' => 'Execuções',
        'commercial-deliveries' => 'Auditoria de Envios',
    ],
    'user' => [
    ...
    'commercial' => [
        'campaigns' => [
            ...
            'stats' => [
                ...
                'with-email' => 'Com E-mail',
                'with-phone' => 'Com Telefone',
            ],
            'audience' => [
                'name' => 'Nome',
                'type' => 'Tipo',
                ...
                'channels' => 'Canais',
                'products' => 'Produtos',
                'commercial-statuses' => 'Status Comercial',
                'entity-person' => 'Pessoa',
                'entity-organization' => 'Empresa',
            ],
            'filters' => [
                'title' => 'Filtros de Segmentação',
                'entity-type' => 'Tipo de Entidade',
                'entity-both' => 'Pessoas e Empresas',
                'entity-person' => 'Somente Pessoas',
                'entity-organization' => 'Somente Empresas',
                'crm-products' => 'Produtos CRM',
                'crm-products-hint' => 'Segure Ctrl para selecionar múltiplos',
                'commercial-statuses' => 'Status Comercial',
                'segment' => 'Segmento',
                'segment-none' => 'Todos',
                'segment-customer-any' => 'Qualquer cliente',
                'segment-non-customer' => 'Não clientes',
                'segment-has-link' => 'Com vínculo comercial',
                'segment-no-link' => 'Sem vínculo comercial',
                'channel-filter' => 'Filtrar por Canal',
                'channel-any' => 'Qualquer canal',
                'only-with-email' => 'Somente com e-mail',
                'only-with-phone' => 'Somente com telefone',
                'only-primary-contact' => 'Apenas contato principal (Empresas)',
                'include-inactive-customer' => 'Incluir clientes inativos',
                'include-former-customer' => 'Incluir ex-clientes',
                'search' => 'Busca',
                'search-placeholder' => 'Buscar por nome ou e-mail...',
            ],
            'index' => [
                'title' => 'Campanhas Comerciais',
                'create-btn' => 'Nova Campanha',
                'datagrid' => [
                    'id' => '#',
                    'name' => 'Nome',
                    'channel' => 'Canal',
                    'status' => 'Status',
                    'execution-type' => 'Tipo de Execução',
            ...
            'create' => [
                ...
                'back-btn' => 'Voltar',
                'save-btn' => 'Salvar',
                'general' => 'Informações da Campanha',
                'name' => 'Nome',
                'name-placeholder' => 'Ex: Oferta de Renovação - Março 2026',
                'description' => 'Descrição',
                'description-placeholder' => 'Descreva o objetivo desta campanha...',
                'channel' => 'Canal',
                'subject' => 'Assunto (E-mail)',
                'subject-placeholder' => 'Assunto do e-mail...',
                'message-body' => 'Corpo da Mensagem',
                'message-body-placeholder' => 'Escreva a mensagem da campanha...',
            ],
            'edit' => [
                'title' => 'Editar Campanha',
                'back-btn' => 'Voltar',
                ...
                'audience-section' => 'Audiência',
                'preview-btn' => 'Gerar Preview',
                'preview-loading' => 'Gerando...',
                'preview-sample' => 'Amostra da audiência (preview):',
                'preview-error' => 'Erro ao gerar preview. Tente novamente.',
                'freeze-btn' => 'Congelar Audiência',
                'freeze-confirm' => 'Isso irá substituir a audiência atual. Confirmar?',
                'recalculate-btn' => 'Recalcular',
                'recalculate-confirm' => 'Isso irá recalcular e substituir a audiência congelada. Confirmar?',
                'audience-frozen-at' => 'Audiência congelada em :date',
                'frozen-audience-preview' => 'Audiência congelada (exibindo :count de :total):',
                'no-audience' => 'Nenhuma audiência congelada. Defina os filtros e clique em "Congelar Audiência".',
                'showing-partial' => 'Exibindo :shown de :total destinatários.',
                'view-all-link' => 'Ver todos',
                'filters-hint' => 'Altere os filtros e salve para depois recalcular a audiência.',
            ],
            'show' => [
                'title' => 'Campanha',
                'back-btn' => 'Voltar',
                'edit-btn' => 'Editar',
                'details' => 'Detalhes',
                'stats' => 'Estatísticas de Audiência',
                'audience' => 'Audiência Congelada',
                'audience-generated' => 'Gerada em :date',
                'active-filters' => 'Filtros Ativos',
                'no-audience' => 'Nenhuma audiência congelada para esta campanha.',
                'go-to-edit' => 'Ir para edição',
                'created-at' => 'Criada em :date',
                'created-by' => 'Criada por :user',
            ],
            'statuses' => [
                'draft' => 'Rascunho',
                'ready' => 'Pronta',
            ...
            'update-success' => 'Campanha atualizada com sucesso.',
            'destroy-success' => 'Campanha excluída com sucesso.',
            'audience-frozen' => 'Audiência congelada com sucesso.',
            'audience-recalculated' => 'Audiência recalculada com sucesso.',
            'locked-error' => 'Esta campanha está em execução e não pode ser editada.',
            'dispatch-success' => 'Campanha disparada com sucesso! O envio está sendo processado em segundo plano.',
            'mark-ready-success' => 'Campanha marcada como pronta.',
            'mark-draft-success' => 'Campanha revertida para rascunho.',
            'deliveries' => [
                'title' => 'Entregas — :name',
                'title-suffix' => 'Entregas',
                'back-btn' => 'Voltar',
                'list-title' => 'Listagem de Entregas',
                'stats-title' => 'Resumo das Entregas',
                'dispatched-at' => 'Disparada em :date',
                'sending-in-progress' => ':count entrega(s) ainda em processamento',
                'statuses' => [
                    'pending' => 'Pendente',
                    'queued' => 'Na Fila',
                    'sending' => 'Enviando',
                ...
                'errors' => [
                    'generic' => 'Não foi possível enviar a mensagem de WhatsApp.',
                    'unsupported-provider' => 'Provedor de WhatsApp não suportado: :provider.',
                    'empty-message' => 'A mensagem está vazia.',
                    'invalid-phone' => 'Telefone inválido. Use formato internacional com código do país.',
                    'host' => 'Host inacessível. Verifique URL, rede e firewall.',
                    'meta-token' => 'Access token Meta inválido.',
                    'meta-phone-id' => 'Phone Number ID Meta inválido.',
            ...
            'dispatch' => [
                'btn' => 'Iniciar Envio',
                'confirm' => 'Isso irá disparar o envio para todos os :count destinatários. Confirmar?',
                'locked-banner' => 'Esta campanha está em estado ":status" — edições e recálculo de audiência estão bloqueados.',
                'mark-ready-btn' => 'Marcar como Pronta',
                'mark-draft-btn' => 'Voltar para Rascunho',
            ...
            'schedule' => [
                ...
                'timezone-placeholder' => 'Exemplo: America/Sao_Paulo',
                'run-at' => 'Executar em',
                'starts-at' => 'Início',
                'ends-at' => 'Fim',
                'recurrence-type' => 'Recorrência',
                'select-recurrence' => 'Selecione a recorrência',
                'time-of-day' => 'Horário',
                'days-of-week' => 'Dias da Semana',
                'day-of-month' => 'Dia do Mês',
                'interval-value' => 'Valor do Intervalo',
                'interval-unit' => 'Unidade do Intervalo',
                'select-interval-unit' => 'Selecione a unidade',
                'window-start' => 'Janela - Início',
                'window-end' => 'Janela - Fim',
                'max-runs' => 'Máximo de Execuções',
                'next-run-at' => 'Próxima Execução',
                'last-run-at' => 'Última Execução',
                'scheduled-for' => 'Agendada para',
                ...
                'resume-btn' => 'Retomar',
                'cancel-btn' => 'Cancelar',
                'run-now-btn' => 'Executar Agora',
                'recalculate-next-btn' => 'Recalcular Próxima',
                'schedule-success' => 'Campanha agendada com sucesso.',
                'pause-success' => 'Campanha pausada com sucesso.',
                'resume-success' => 'Campanha retomada com sucesso.',
                'cancel-success' => 'Campanha cancelada com sucesso.',
                'run-now-success' => 'Campanha enfileirada para execução imediata.',
                'recalculate-next-success' => 'Próxima execução recalculada com sucesso.',
                'execution-types' => [
                    'manual' => 'Manual',
                    'once' => 'Única',
                    'recurring' => 'Recorrente',
                    'windowed-recurring' => 'Recorrente com Janela',
                    'windowed_recurring' => 'Recorrente com Janela',
                ],
                'recurrence-types' => [
                    'daily' => 'Diária',
                    'weekly' => 'Semanal',
            ...
            'metrics' => [
                ...
                'in-progress' => ':count entrega(s) ainda em andamento',
                'total-label' => 'total',
                ...
                'recalculate-btn' => 'Atualizar Métricas',
                'recalculated' => 'Métricas atualizadas com sucesso.',
            ],

            'delivery-show' => [
                'title' => 'Entrega #:id',
                'heading' => 'Entrega para :name',
                'campaign-ref' => 'Campanha: :name',
                'back-btn' => 'Voltar para Entregas',
                'recipient-section' => 'Destinatário',
                'failed-at' => 'Falhou Em',
                'logs-title' => 'Log de Processamento',
                'no-logs' => 'Nenhum registro de log para esta entrega.',
                'context' => 'Contexto',
                'expand' => 'Ver mensagem completa',
                'collapse' => 'Recolher',
            ],

            'audience-invalidated' => 'Campanha salva. A audiência congelada foi removida porque um campo crítico foi alterado — por favor, congele novamente antes de disparar.',

            'duplicate' => [
                'btn' => 'Duplicar',
                'success' => 'Campanha duplicada com sucesso. Você pode editar a cópia agora.',
                'name-prefix' => 'Cópia de',
            ],

            'guard' => [
                'campaign-edit-blocked' => 'Esta campanha (:status) não pode ser editada.',
                'campaign-audience-blocked' => 'A audiência não pode ser atualizada enquanto a campanha está com status :status.',
                'campaign-dispatch-not-ready' => 'Somente campanhas com status "pronta" podem ser disparadas (atual: :status).',
                'campaign-dispatch-no-audience' => 'A campanha não possui audiência congelada. Congele a audiência antes de disparar.',
                'campaign-delete-sending' => 'Não é possível excluir uma campanha que está sendo enviada.',
                'campaign-mark-ready-not-draft' => 'Apenas campanhas em rascunho podem ser marcadas como prontas.',

                'campaign-not-ready-no-audience' => 'Nenhuma audiência congelada — congele a audiência antes de prosseguir.',
                'campaign-not-ready-no-body' => 'O corpo da mensagem está vazio.',
                'campaign-not-ready-no-subject' => 'O assunto é obrigatório para campanhas de e-mail.',
                'campaign-not-ready-audience-stale' => 'A audiência congelada pode estar desatualizada — considere recalcular.',
                'campaign-not-ready-is-draft' => 'A campanha ainda está em rascunho.',

                'not-ready-title' => 'Esta campanha não está pronta para disparo:',
                'audience-stale-warning' => 'A audiência congelada pode estar desatualizada. A campanha foi editada após o último congelamento — considere recalcular.',
                'campaign-archived-banner' => 'Esta campanha está arquivada e é somente leitura.',
                'form-read-only' => 'Somente leitura — esta campanha não pode ser editada no status atual.',
            ],

            'template' => [
                'variables-title' => 'Variáveis do Template',
                'variables-hint' => 'Clique em uma variável para copiar e cole no assunto ou no corpo da mensagem.',
                'copy-hint' => 'Clique para copiar',
                'preview-title' => 'Pré-visualização do Template',
                'preview-btn' => 'Pré-visualizar',
                'preview-error' => 'Falha ao gerar pré-visualização. Tente novamente.',
                'preview-dummy-notice' => 'Nenhuma audiência congelada — usando dados de exemplo para a pré-visualização.',
                'preview-sample-label' => 'Dados de exemplo utilizados nesta pré-visualização',
                'var-name' => 'Nome completo',
                'var-first-name' => 'Primeiro nome',
                'var-organization' => 'Empresa / organização',
                'var-email' => 'Endereço de e-mail',
                'var-phone' => 'Telefone',
                'var-entity-type' => 'Tipo: person ou organization',
                'var-products' => 'Produtos associados (separados por vírgula)',
                'var-commercial-statuses' => 'Status comerciais (separados por vírgula)',
                'var-channel' => 'Canal de envio: email ou whatsapp',
                'var-campaign-name' => 'Nome da campanha',
                'var-campaign-channel' => 'Canal da campanha',
            ],
        ],
        ...
        'executions' => [
            ...
            'index' => [
                'title' => 'Execuções',
                'menu-shortcut' => 'Execuções',
                'scoped-campaign' => 'Campanha: :name',
                'back-to-campaigns' => 'Voltar para Campanhas',
                'view-campaign' => 'Ver Campanha',
            ],

            'datagrid' => [
                'id' => '#',
                'campaign' => 'Campanha',
                'campaign-filter' => 'Campanha',
                'execution-type' => 'Tipo de Execução',
                'scheduled-for' => 'Programada para',
                'started-at' => 'Iniciada em',
                'finished-at' => 'Finalizada em',
                'status' => 'Status',
                'total-deliveries' => 'Total de Envios',
                'sent' => 'Enviados',
                'failed' => 'Falhas',
                'next-run-at' => 'Próxima Execução',
                'view' => 'Visualizar',
                'audit-deliveries' => 'Abrir Auditoria',
            ],

            'show' => [
                'title' => 'Execução #:id',
                'heading' => 'Execução #:id',
                'back-btn' => 'Voltar para Execuções',
                'view-campaign' => 'Ver Campanha',
                'open-delivery-audit' => 'Abrir Auditoria de Envios',
                'run-info' => 'Detalhes da Execução',
                'campaign-info' => 'Contexto da Campanha',
                'created-by' => 'Criada por',
                'delivery-list' => 'Envios desta Execução',
            ],
        ],
        ...
        'delivery-audit' => [
            ...
            'index' => [
                ...
                'scoped-campaign' => 'Campanha: :name',
                'scoped-run' => 'Execução: #:id',
                'back-to-campaigns' => 'Voltar para Campanhas',
                'view-executions' => 'Ver Execuções',
            ...
            'datagrid' => [
                ...
                'entity-type' => 'Tipo de Entidade',
                'channel' => 'Canal',
                'destination' => 'Destino Utilizado',
                'normalized-destination' => 'Destino Normalizado',
                'status' => 'Status',
                'sent-at' => 'Enviado em',
                'failed-at' => 'Falhou em',
                'error' => 'Erro',
                'provider-message-id' => 'ID da Mensagem no Provedor',
                'view' => 'Visualizar',
                'only-failures' => 'Somente falhas',
            ],

            'show' => [
                'title' => 'Envio #:id',
                'heading' => 'Envio #:id',
                'back-btn' => 'Voltar para Auditoria',
                'view-campaign' => 'Ver Campanha',
                'view-run' => 'Ver Execução',
                'delivery-info' => 'Informações do Envio',
                'logs-title' => 'Log de Processamento',
                'context' => 'Contexto',
                'no-logs' => 'Nenhum log encontrado para este envio.',
            ],
        ],
    ],
];
