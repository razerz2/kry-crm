...
return [
    ...
    'contacts' => [
        ...
        'account-products' => [
            'save-success' => 'Commercial relationship saved successfully.',
            'delete-success' => 'Commercial relationship removed successfully.',
        ],
    ],
    ...
    'commercial' => [
        'campaigns' => [
            ...
            'audience' => [
                ...
                'channels' => 'Channels',
                'products' => 'Products',
                'commercial-statuses' => 'Commercial Status',
            ...
            'filters' => [
                ...
                'entity-type' => 'Entity Type',
                'entity-both' => 'Persons & Organizations',
                'entity-person' => 'Persons Only',
                'entity-organization' => 'Organizations Only',
                'crm-products' => 'CRM Products',
                'crm-products-hint' => 'Hold Ctrl to select multiple',
                'commercial-statuses' => 'Commercial Status',
                'segment' => 'Segment',
                'segment-none' => 'All',
                'segment-customer-any' => 'Any customer',
                'segment-non-customer' => 'Non-customers',
                'segment-has-link' => 'With commercial link',
                'segment-no-link' => 'Without commercial link',
                'channel-filter' => 'Filter by Channel',
                'channel-any' => 'Any channel',
                'only-with-email' => 'Only with email',
                'only-with-phone' => 'Only with phone',
                'only-primary-contact' => 'Primary contact only (Organizations)',
                'include-inactive-customer' => 'Include inactive customers',
                'include-former-customer' => 'Include former customers',
                'search' => 'Search',
            ...
            'create' => [
                ...
                'name' => 'Name',
                'name-placeholder' => 'e.g. Renewal Offer – March 2026',
                'description' => 'Description',
                'description-placeholder' => 'Describe the goal of this campaign...',
                'channel' => 'Channel',
                'subject' => 'Subject (Email)',
                'subject-placeholder' => 'Email subject...',
                'message-body' => 'Message Body',
                'message-body-placeholder' => 'Write the campaign message...',
            ],
            'edit' => [
                'title' => 'Edit Campaign',
                'back-btn' => 'Back',
                ...
                'preview-btn' => 'Generate Preview',
                'preview-loading' => 'Generating...',
                'preview-sample' => 'Audience sample (preview):',
                'preview-error' => 'Error generating preview. Please try again.',
                'freeze-btn' => 'Freeze Audience',
                'freeze-confirm' => 'This will replace the current audience. Confirm?',
                'recalculate-btn' => 'Recalculate',
                'recalculate-confirm' => 'This will recalculate and replace the frozen audience. Confirm?',
                'audience-frozen-at' => 'Audience frozen at :date',
                'frozen-audience-preview' => 'Frozen audience (showing :count of :total):',
                'no-audience' => 'No frozen audience. Set your filters and click "Freeze Audience".',
                'showing-partial' => 'Showing :shown of :total recipients.',
                'view-all-link' => 'View all',
                'filters-hint' => 'Change filters and save to recalculate the audience later.',
            ],
            'show' => [
                'title' => 'Campaign',
                'back-btn' => 'Back',
                ...
                'audience-generated' => 'Generated at :date',
                'active-filters' => 'Active Filters',
                'no-audience' => 'No frozen audience for this campaign.',
            ...
            'create-success' => 'Campaign created successfully.',
            'update-success' => 'Campaign updated successfully.',
            'destroy-success' => 'Campaign deleted successfully.',
            'audience-frozen' => 'Audience frozen successfully.',
            'audience-recalculated' => 'Audience recalculated successfully.',
            'locked-error' => 'This campaign is locked and cannot be edited.',
            'dispatch-success' => 'Campaign dispatched! Sending is being processed in the background.',
            'mark-ready-success' => 'Campaign marked as ready.',
            'mark-draft-success' => 'Campaign reverted to draft.',
            'deliveries' => [
                'title' => 'Deliveries — :name',
                'title-suffix' => 'Deliveries',
                'back-btn' => 'Back',
                'list-title' => 'Delivery List',
                'stats-title' => 'Delivery Summary',
                'dispatched-at' => 'Dispatched at :date',
                'sending-in-progress' => ':count delivery(ies) still processing',
                'statuses' => [
                    'pending' => 'Pending',
                    'queued' => 'Queued',
                    'sending' => 'Sending',
            ...
            'dispatch' => [
                'btn' => 'Start Sending',
                'confirm' => 'This will dispatch the campaign to :count recipients. Confirm?',
                'locked-banner' => 'This campaign is ":status" — editing and audience recalculation are locked.',
            ...
            'metrics' => [
                ...
                'in-progress' => ':count delivery(ies) still in progress',
                'total-label' => 'total',
                ...
                'recalculate-btn' => 'Refresh Metrics',
                'recalculated' => 'Metrics refreshed successfully.',
            ],

            'delivery-show' => [
                'title' => 'Delivery #:id',
                'heading' => 'Delivery to :name',
                'campaign-ref' => 'Campaign: :name',
                'back-btn' => 'Back to Deliveries',
            ...
            'audience-invalidated' => 'Campaign saved. The frozen audience was cleared because a critical field changed — please re-freeze before dispatching.',

            'duplicate' => [
                'btn' => 'Duplicate',
                'success' => 'Campaign duplicated successfully. You can now edit the copy.',
                'name-prefix' => 'Copy of',
            ],

            'guard' => [
                // Edit-blocked errors
                'campaign-edit-blocked' => 'This campaign (:status) cannot be edited.',
                'campaign-audience-blocked' => 'The audience cannot be updated while the campaign is :status.',
                'campaign-dispatch-not-ready' => 'Only campaigns in "ready" status can be dispatched (current: :status).',
                'campaign-dispatch-no-audience' => 'The campaign has no frozen audience. Please freeze the audience first.',
                'campaign-delete-sending' => 'Cannot delete a campaign that is currently sending.',
                'campaign-mark-ready-not-draft' => 'Only draft campaigns can be marked as ready.',

                // Readiness issue keys (one sentence each)
                'campaign-not-ready-no-audience' => 'No frozen audience — please freeze the audience first.',
                'campaign-not-ready-no-body' => 'Message body is empty.',
                'campaign-not-ready-no-subject' => 'Subject line is required for email campaigns.',
                'campaign-not-ready-audience-stale' => 'The frozen audience may be outdated — consider recalculating.',
                'campaign-not-ready-is-draft' => 'Campaign is still in draft status.',

                // UI notices
                'not-ready-title' => 'This campaign is not ready to dispatch:',
                'audience-stale-warning' => 'The frozen audience may be outdated. The campaign was edited after the last audience freeze — consider recalculating.',
                'campaign-archived-banner' => 'This campaign is archived and is read-only.',
                'form-read-only' => 'Read-only — this campaign cannot be edited in its current status.',
            ],

            'template' => [
                'variables-title' => 'Template Variables',
                'variables-hint' => 'Click a variable to copy it, then paste it into the subject or message body.',
                'copy-hint' => 'Click to copy',
                'preview-title' => 'Template Preview',
                'preview-btn' => 'Preview',
                'preview-error' => 'Failed to generate preview. Please try again.',
                'preview-dummy-notice' => 'No audience frozen yet — using sample data for preview.',
                'preview-sample-label' => 'Sample data used in this preview',
                'var-name' => 'Full name',
                'var-first-name' => 'First name',
                'var-organization' => 'Organisation / company',
                'var-email' => 'Email address',
                'var-phone' => 'Phone number',
                'var-entity-type' => 'Type: person or organization',
                'var-products' => 'Associated products (comma-separated)',
                'var-commercial-statuses' => 'Commercial statuses (comma-separated)',
